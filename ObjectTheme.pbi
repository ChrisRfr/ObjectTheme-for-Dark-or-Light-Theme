...
Module ObjectTheme
  ...
  Procedure EditProc(hWnd, uMsg, wParam, lParam)
    ...
    With *ObjectTheme  
      Select uMsg
        ...
        Case #WM_ENABLE
          If wParam
            _PB(SetGadgetColor)(\PBGadget, #PB_Gadget_BackColor, \ObjectInfo\lBackColor)
            _PB(SetGadgetColor)(\PBGadget, #PB_Gadget_FrontColor, \ObjectInfo\lFrontColor)
          Else
            _PB(SetGadgetColor)(\PBGadget, #PB_Gadget_BackColor, \ObjectInfo\lGrayBackColor)
  ...
  Import ""
    ...
    PB_Object_EnumerateNext(PB_Gadget_Objects, *Object.Integer)
  ...
  Procedure SetWindowThemeColor(*ObjectTheme.ObjectTheme_INFO, Attribute, Value, InitLevel = #True)
    ...
    Select Attribute
      ...
      Case #PB_Gadget_DarkMode
        If Value = #PB_Default
          If IsDarkColor(GetObjectThemeAttribute(#PB_WindowType, #PB_Gadget_BackColor)) : Value = #True : Else : Value = #False : EndIf
        EndIf
        PushMapPosition(ObjectTheme())
        ForEach ObjectTheme()
          Select ObjectTheme()\PBGadgetType
    ...
    With *ObjectTheme\ObjectInfo
      Select Attribute
        ...
        Case #PB_Gadget_BackColor
          ...
          Select *ObjectTheme\PBGadgetType
            ...
            Case #PB_GadgetType_ExplorerList, #PB_GadgetType_ListIcon
              _SetObjectBrush(\lBackColor, \lBrushBackColor, SavBackColor)
              _PB(SetGadgetColor)(*ObjectTheme\PBGadget, #PB_Gadget_BackColor, \lBackColor)
        ...
        Case #PB_Gadget_InactiveTabColor 
          ...
          If Value = #PB_Default
            If IsDarkColor(\lBackColor) : \lInactiveTabColor = AccentColor(\lBackColor, 40) : Else : \lInactiveTabColor = AccentColor(\lBackColor, -40) : EndIf
          Else
        ...
        Case #PB_Gadget_EditBoxColor
          ...
          If Value = #PB_Default
            If IsDarkColor(\lBackColor) : \lEditBoxColor = AccentColor(\lBackColor, 15) : Else : \lEditBoxColor = AccentColor(\lBackColor, -15) : EndIf
          Else
            \lEditBoxColor = Value
          EndIf
        ...
        Case #PB_Gadget_FrontColor
          If Value = #PB_Default
            Select *ObjectTheme\PBGadgetType
              Case #PB_GadgetType_ProgressBar
                If IsDarkColor(\lBackColor) : \lFrontColor = AccentColor(\lBackColor, 100) : Else : \lFrontColor = AccentColor(\lBackColor, -100) : EndIf
              Default
                If IsDarkColor(\lBackColor) : \lFrontColor = #White : Else : \lFrontColor = #Black : EndIf
            EndSelect
          Else
            \lFrontColor = Value
          EndIf
          ...
          Select *ObjectTheme\PBGadgetType
            Case #PB_GadgetType_Calendar, #PB_GadgetType_Date, #PB_GadgetType_Editor, #PB_GadgetType_ExplorerList, #PB_GadgetType_ExplorerTree, 
              ...
              _PB(SetGadgetColor)(*ObjectTheme\PBGadget, #PB_Gadget_FrontColor, \lFrontColor)
          EndSelect
          ReturnValue = #True
        ...
        Case #PB_Gadget_LineColor
          ...
          Else
            \lLineColor = Value
          EndIf
          _PB(SetGadgetColor)(*ObjectTheme\PBGadget, #PB_Gadget_LineColor, \lLineColor)   ; Display if #PB_Explorer_GridLines used
          ReturnValue = #True
        ...
        Case #PB_Gadget_TitleBackColor
          If Value = #PB_Default
            Select *ObjectTheme\PBGadgetType
              Case #PB_GadgetType_ExplorerList, #PB_GadgetType_ListIcon
                If IsDarkColor(\lBackColor) : \lTitleBackColor = AccentColor(\lBackColor, 40) : Else : \lTitleBackColor = AccentColor(\lBackColor, -40) : EndIf
          ...
          Select *ObjectTheme\PBGadgetType
            ...
            Case #PB_GadgetType_Calendar, #PB_GadgetType_Date
              _PB(SetGadgetColor)(*ObjectTheme\PBGadget, #PB_Gadget_TitleBackColor, \lTitleBackColor)   ; Display if #PB_Explorer_GridLines used
          EndSelect
        ...
        Case #PB_Gadget_TitleFrontColor
          ...
          EndIf
          _PB(SetGadgetColor)(*ObjectTheme\PBGadget, #PB_Gadget_TitleFrontColor, \lTitleFrontColor)   ; Display if #PB_Explorer_GridLines used
          ReturnValue = #True
    ...
    Select *ObjectTheme\PBGadgetType
      Case #PB_GadgetType_ComboBox, #PB_GadgetType_Editor, #PB_GadgetType_ExplorerList, #PB_GadgetType_ExplorerTree, #PB_GadgetType_ListIcon,
        ...
        If DarkMode = #PB_Default
          If IsDarkColor(GetObjectThemeAttribute(#PB_WindowType, #PB_Gadget_BackColor)) : DarkMode = #True : Else : DarkMode = #False : EndIf
        EndIf
        If DarkMode
          _SetDarkTheme(*ObjectTheme\IDGadget)
        Else
      ...
      Select Attribute
        ...
        Case #PB_Gadget_BackColor
          If Value = #PB_Default
            ...
            EndIf
            If IsDarkColor(\lButtonBackColor) : \lButtonBackColor = AccentColor(\lButtonBackColor, 80) : EndIf
          Else
        ...
        Case #PB_Gadget_OuterColor
          If Value = #PB_Default
            ...
            EndIf
            If Not IsDarkColor(\lButtonOuterColor) : \lButtonOuterColor = AccentColor(\lButtonOuterColor, -80) : EndIf
          Else
        ...
        Case #PB_Gadget_GrayBackColor
          If Value = #PB_Default
            ...
            Else
              \lGrayBackColor =  DisabledLightColor(\lButtonBackColor)
            EndIf
          Else
            \lGrayBackColor    = Value
          EndIf
        ...
        Case #PB_Gadget_GrayTextColor
          If Value = #PB_Default
            ...
            Else
              \lGrayTextColor    = DisabledLightColor(\lFrontColor)
            EndIf
          Else
            \lGrayTextColor      = Value
          EndIf
  ...
  Procedure GetObjectColor(Gadget, Attribute)
    _ProcedureReturnIf(Not IsGadget(Gadget), #PB_Default)
    Protected ReturnValue = #PB_Default
